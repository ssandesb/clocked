...
Usage:
    ...
    python -m bots.tasks.bulk_create --file bots/tasks/data/tasks.yaml --dry-run

See bots/tasks/data/tasks.example.yaml for the input format.
"""
...
DEFAULT_TASKS_FILE = REPO_ROOT / "bots" / "tasks" / "data" / "tasks.yaml"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="YAML file with tasks (default: bots/tasks/data/tasks.yaml)",
    )
